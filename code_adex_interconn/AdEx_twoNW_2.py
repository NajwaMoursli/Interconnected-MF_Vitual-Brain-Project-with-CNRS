...
#P_edB=PoissonGroup(8000, .6*Hz) #here we have only the external input in B network 
...
S_ed_inB = Synapses(P_edA, G3, on_pre='GsynE_post+=Qe')
...
S_ed_exB = Synapses(P_edA, G4, on_pre='GsynE_post+=Qe')
